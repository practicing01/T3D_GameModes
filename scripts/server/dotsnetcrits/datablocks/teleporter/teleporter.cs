datablock SFXProfile(DNCTeleportEntrance)
{
...
datablock SFXProfile(DNCTeleportSound)
{
   fileName = "art/sound/dotsnetcrits/manuts_click-3a.ogg";
   description = Audio2D;
   preload = true;
...
datablock ExplosionData(DNCEntranceEffect : EntranceEffect)
{
  soundProfile = DNCTeleportEntrance;
};

datablock TriggerData(DNCTeleporterTrigger : TeleporterTrigger)
{
  entranceEffect = DNCEntranceEffect;
	exiteffect = DNCEntranceEffect;
  teleportSound = DNCTeleportSound;
};
...
function DNCTeleporterTrigger::onAdd( %this, %teleporter )
{
...
function DNCTeleporterTrigger::onLeaveTrigger(%this,%trigger,%obj)
{
...
function DNCTeleporterTrigger::onEnterTrigger(%this, %entrance, %obj)
{
...
function DNCTeleporterTrigger::verifyObject(%this, %obj, %entrance, %exit)
{
...
function DNCTeleporterTrigger::teleportPlayer(%this, %player, %exit)
{
...
function DNCTeleporterTrigger::teleFrag(%this, %player, %exit)
{
