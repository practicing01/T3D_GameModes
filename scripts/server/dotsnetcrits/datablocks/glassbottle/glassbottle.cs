//-----------------------------------------------------------------------------
// glassBottle weapon. This file contains all the items related to this weapon
...
// is mounted onto a shape, the glassBottleImage is used.

datablock SFXProfile(glassBottleFireSound)
{
...
datablock ItemData(glassBottle)
{
   ...
   emap = true;
    ...
    pickUpName = "a glassBottle";
    description = "glassBottle";
    maxInventory = 1;
...
//--------------------------------------------------------------------------
// glassBottle image which does all the work.  Images do not normally exist in
// the world, they can only be mounted on ShapeBase objects.

datablock ShapeBaseImageData(glassBottleImage)
{
   // Basic Item properties
   shapeFile = "art/shapes/dotsnetcrits/weapons/glassBottle/glassBottle.cached.dts";
   //shapeFileFP = "art/shapes/dotsnetcrits/weapons/glassBottle/glassBottle.cached.dts";
   emap = false;
   ...
   //imageAnimPrefix = "glassBottle";
   //imageAnimPrefixFP = "glassBottle";
   ...
   //stateSound[4]                    = glassBottleReloadSound;
   ...
   //stateSound[6]                    = glassBottleFireEmptySound;
};


//-----------------------------------------------------------------------------

function glassBottleImage::onMount( %this, %obj, %slot )
{
...
function glassBottleImage::onUnmount( %this, %obj, %slot )
{
   %obj.client.RefreshWeaponHud( 0, "", "" );
}

function glassBottleImage::onFire(%this, %obj, %slot)
{
   %pos = %obj.getPosition();
   ...
   %glassBottle = new StaticShape()
   {
     dataBlock = "glassBottleStaticShapeData";
     position = %objTarget.position;
     rotation = "1 0 0 0";
     scale = "8.0 8.0 8.0";
   };

   %glassBottle.schedule(5000, "delete");
...
DefaultPlayerData.maxInv[glassBottle] = 1;
