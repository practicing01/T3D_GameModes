//-----------------------------------------------------------------------------
// fanDagger weapon. This file contains all the items related to this weapon
...
// is mounted onto a shape, the fanDaggerImage is used.

datablock SFXProfile(fanDaggerFireSound)
{
...
datablock ItemData(fanDagger)
{
   ...
   shapeFile = "art/shapes/dotsnetcrits/weapons/fanDagger/fanDagger.cached.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
    ...
    pickUpName = "a fanDagger";
    description = "fanDagger";
    maxInventory = 1;
    damageType = "meleeDamage";
    damageRadius = 5;
    directDamage = 10;
    image = fanDaggerImage;
    reticle = "crossHair";
...
//--------------------------------------------------------------------------
// fanDagger image which does all the work.  Images do not normally exist in
// the world, they can only be mounted on ShapeBase objects.

datablock ShapeBaseImageData(fanDaggerImage)
{
   // Basic Item properties
   shapeFile = "art/shapes/dotsnetcrits/weapons/fanDagger/fanDagger.cached.dts";
   //shapeFileFP = "art/shapes/dotsnetcrits/weapons/fanDagger/fanDagger.cached.dts";
   emap = false;
   ...
   //imageAnimPrefix = "fanDagger";
   //imageAnimPrefixFP = "fanDagger";
   ...
   stateSound[3]                    = fanDaggerFireSound;
   ...
   //stateSound[4]                    = fanDaggerReloadSound;
   ...
   stateSound[6]                    = fanDaggerFireEmptySound;
};


//-----------------------------------------------------------------------------

function fanDaggerImage::onMount( %this, %obj, %slot )
{
...
function fanDaggerImage::onUnmount( %this, %obj, %slot )
{
   %obj.client.RefreshWeaponHud( 0, "", "" );
}

function fanDaggerImage::onFire(%this, %obj, %slot)
{
   %pos = %obj.getPosition();
   ...
   while ( (%targetObject = containerSearchNext()) != 0 )
   {
     if(%targetObject != %obj)
     {
      %targetObject.damage(%obj, %pos, %this.item.directDamage, "fanDagger");
...
DefaultPlayerData.maxInv[fanDagger] = 1;
