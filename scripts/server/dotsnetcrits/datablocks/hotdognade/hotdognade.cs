//-----------------------------------------------------------------------------
// hotdogNade weapon. This file contains all the items related to this weapon
...
datablock ProximityMineData(hotdogNade)
{
   ...
   shapeFile = "art/shapes/dotsnetcrits/weapons/hotdogNade/hotdogNade.cached.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   sticky = true;
...
//--------------------------------------------------------------------------
// hotdogNade image which does all the work.  Images do not normally exist in
// the world, they can only be mounted on ShapeBase objects.

datablock ShapeBaseImageData(hotdogNadeImage)
{
   // Basic Item properties
   shapeFile = "art/shapes/dotsnetcrits/weapons/hotdogNade/hotdogNade.cached.dts";
   //shapeFileFP = "art/shapes/dotsnetcrits/weapons/hotdogNade/hotdogNade.cached.dts";
   emap = false;
   ...
   //imageAnimPrefix = "hotdogNade";
   //imageAnimPrefixFP = "hotdogNade";
   ...
   //stateSound[4]                    = hotdogNadeReloadSound;
...
function hotdogNade::onUse(%this, %obj)
{
   // Act like a weapon on use
   Weapon::onUse( %this, %obj );
}

function hotdogNade::onPickup( %this, %obj, %shape, %amount )
{
   // Act like a weapon on pickup
   Weapon::onPickup( %this, %obj, %shape, %amount );
}

function hotdogNade::onInventory( %this, %obj, %amount )
{
   %obj.client.setAmmoAmountHud( 1, %amount );

   if (!%amount)
   {
     %obj.setInventory(hotdogNade, 1);
     return;
   }
...
function hotdogNadeImage::onMount( %this, %obj, %slot )
{
...
function hotdogNadeImage::onUnmount( %this, %obj, %slot )
{
   %obj.client.RefreshWeaponHud( 0, "", "" );
}

function hotdogNadeImage::onFire( %this, %obj, %slot )
{
   // To fire a deployable mine is to throw it
   %obj.throw( %this.item );
}

function hotdogNade::onExplode( %this, %obj, %position )
{
...
DefaultPlayerData.maxInv[hotdogNade] = 1;
