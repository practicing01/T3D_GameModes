//-----------------------------------------------------------------------------
// lightDagger weapon. This file contains all the items related to this weapon
...
datablock ItemData(lightDagger)
{
   ...
   shapeFile = "art/shapes/dotsnetcrits/weapons/lightDagger/lightDagger.cached.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
    ...
    pickUpName = "a lightDagger";
    description = "lightDagger";
    maxInventory = 1;
    damageType = "meleeDamage";
    damageRadius = 2;
    directDamage = 40;
    image = lightDaggerImage;
    reticle = "crossHair";
...
//--------------------------------------------------------------------------
// lightDagger image which does all the work.  Images do not normally exist in
// the world, they can only be mounted on ShapeBase objects.

datablock ShapeBaseImageData(lightDaggerImage)
{
   // Basic Item properties
   shapeFile = "art/shapes/dotsnetcrits/weapons/lightDagger/lightDagger.cached.dts";
   //shapeFileFP = "art/shapes/dotsnetcrits/weapons/lightDagger/lightDagger.cached.dts";
   emap = false;
   ...
   //imageAnimPrefix = "lightDagger";
   //imageAnimPrefixFP = "lightDagger";
   ...
   stateSound[3]                    = lightDaggerFireSound;
   ...
   //stateSound[4]                    = lightDaggerReloadSound;
   ...
   //stateSound[6]                    = lightDaggerFireEmptySound;
};


//-----------------------------------------------------------------------------

function lightDaggerImage::onMount( %this, %obj, %slot )
{
...
function lightDaggerImage::onUnmount( %this, %obj, %slot )
{
   %obj.client.RefreshWeaponHud( 0, "", "" );
}

function lightDaggerImage::onFire(%this, %obj, %slot)
{
  %pos = %obj.getPosition();
  ...
  while ( (%targetObject = containerSearchNext()) != 0 )
  {
    if(%targetObject != %obj)
    {
      %targetObject.damage(%obj, %pos, %this.item.directDamage, "lightDagger");
    }
  }

  %impulseDir = VectorNormalize(%obj.getEyeVector());
  %obj.setVelocity(VectorScale(%impulseDir, 500.0));
}

DefaultPlayerData.maxInv[lightDagger] = 1;
