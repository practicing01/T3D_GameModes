//-----------------------------------------------------------------------------
// scissors weapon. This file contains all the items related to this weapon
...
// is mounted onto a shape, the scissorsImage is used.
...
datablock ItemData(scissors)
{
   ...
   shapeFile = "art/shapes/dotsnetcrits/weapons/scissors/scissors.cached.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
...
//--------------------------------------------------------------------------
// scissors image which does all the work.  Images do not normally exist in
// the world, they can only be mounted on ShapeBase objects.

datablock ShapeBaseImageData(scissorsImage)
{
   // Basic Item properties
   shapeFile = "art/shapes/dotsnetcrits/weapons/scissors/scissors.cached.dts";
   //shapeFileFP = "art/shapes/dotsnetcrits/weapons/scissors/scissors.cached.dts";
   emap = false;
   ...
   //imageAnimPrefix = "scissors";
   //imageAnimPrefixFP = "scissors";
   ...
   stateSound[3]                    = scissorsFireSound;
   ...
   //stateSound[4]                    = scissorsReloadSound;
   ...
   //stateSound[6]                    = scissorsFireEmptySound;
};


//-----------------------------------------------------------------------------

function scissorsImage::onMount( %this, %obj, %slot )
{
...
function scissorsImage::onUnmount( %this, %obj, %slot )
{
   %obj.client.RefreshWeaponHud( 0, "", "" );
}

function scissorsImage::onFire(%this, %obj, %slot)
{
   %pos = %obj.getPosition();
   ...
   while ( (%targetObject = containerSearchNext()) != 0 )
   {
     if(%targetObject != %obj)
     {
      %targetObject.damage(%obj, %pos, %this.item.directDamage, "scissors");
     }
   }
}

DefaultPlayerData.maxInv[scissors] = 1;
