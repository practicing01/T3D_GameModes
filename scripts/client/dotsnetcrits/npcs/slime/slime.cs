function slimeScriptMsgListenerClient::NPCAction(%this, %key)
{
  commandToServer('NPCActionslime', %key);
}

function slimeScriptMsgListenerClient::onAdd(%this)
{
  //
}

function slimeScriptMsgListenerClient::onRemove(%this)
{
...
function slimeScriptMsgListenerClient::onNPCLoadRequest(%this, %data)
{
...
{
  class = "slimeScriptMsgListenerClient";
  npc_ = "slime";
  actionMap_ = "";
};
