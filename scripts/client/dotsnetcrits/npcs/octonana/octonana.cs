function octonanaScriptMsgListenerClient::NPCAction(%this, %key)
{
  commandToServer('NPCActionoctonana', %key);
}

function octonanaScriptMsgListenerClient::onAdd(%this)
{
  //
}

function octonanaScriptMsgListenerClient::onRemove(%this)
{
...
function octonanaScriptMsgListenerClient::onNPCLoadRequest(%this, %data)
{
...
{
  class = "octonanaScriptMsgListenerClient";
  npc_ = "octonana";
  actionMap_ = "";
};
