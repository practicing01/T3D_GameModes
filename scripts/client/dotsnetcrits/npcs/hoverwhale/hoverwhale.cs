function HoverWhaleScriptMsgListenerClient::NPCAction(%this, %key)
{
  commandToServer('NPCActionHoverWhale', %key);
}

function HoverWhaleScriptMsgListenerClient::onAdd(%this)
{
  //
}

function HoverWhaleScriptMsgListenerClient::onRemove(%this)
{
...
function HoverWhaleScriptMsgListenerClient::onNPCLoadRequest(%this, %data)
{
...
{
  class = "HoverWhaleScriptMsgListenerClient";
  npc_ = "HoverWhale";
  actionMap_ = "";
};
