function lechosaScriptMsgListenerClient::NPCAction(%this, %key)
{
  commandToServer('NPCActionlechosa', %key);
}

function lechosaScriptMsgListenerClient::onAdd(%this)
{
  //
}

function lechosaScriptMsgListenerClient::onRemove(%this)
{
...
function lechosaScriptMsgListenerClient::onNPCLoadRequest(%this, %data)
{
...
{
  class = "lechosaScriptMsgListenerClient";
  npc_ = "lechosa";
  actionMap_ = "";
};
