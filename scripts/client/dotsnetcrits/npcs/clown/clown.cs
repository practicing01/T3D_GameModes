function clownScriptMsgListenerClient::NPCAction(%this, %key)
{
  commandToServer('NPCActionclown', %key);
}

function clownScriptMsgListenerClient::onAdd(%this)
{
  //
}

function clownScriptMsgListenerClient::onRemove(%this)
{
...
function clownScriptMsgListenerClient::onNPCLoadRequest(%this, %data)
{
...
{
  class = "clownScriptMsgListenerClient";
  npc_ = "clown";
  actionMap_ = "";
};
