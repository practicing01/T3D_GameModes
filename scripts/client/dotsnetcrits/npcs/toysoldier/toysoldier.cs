function toySoldierScriptMsgListenerClient::NPCAction(%this, %key)
{
  commandToServer('NPCActionToySoldier', %key);
}

function toySoldierScriptMsgListenerClient::onAdd(%this)
{
  //
}

function toySoldierScriptMsgListenerClient::onRemove(%this)
{
...
function toySoldierScriptMsgListenerClient::onNPCLoadRequest(%this, %data)
{
...
{
  class = "toySoldierScriptMsgListenerClient";
  npc_ = "toysoldier";
  actionMap_ = "";
};
