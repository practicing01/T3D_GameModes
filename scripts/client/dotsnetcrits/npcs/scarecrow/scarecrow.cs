function scarecrowScriptMsgListenerClient::NPCAction(%this, %key)
{
  commandToServer('NPCActionscarecrow', %key);
}

function scarecrowScriptMsgListenerClient::onAdd(%this)
{
  //
}

function scarecrowScriptMsgListenerClient::onRemove(%this)
{
...
function scarecrowScriptMsgListenerClient::onNPCLoadRequest(%this, %data)
{
  return;//no actionmap for this npc
...
{
  class = "scarecrowScriptMsgListenerClient";
  npc_ = "scarecrow";
  actionMap_ = "";
};
