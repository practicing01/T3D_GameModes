//-----------------------------------------------------------------------------
// noodleBlade weapon. This file contains all the items related to this weapon
...
datablock ItemData(noodleBlade)
{
   ...
   shapeFile = "art/shapes/dotsnetcrits/weapons/noodleBlade/noodleBlade.cached.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
    ...
    pickUpName = "a noodleBlade";
    description = "noodleBlade";
    maxInventory = 1;
...
//--------------------------------------------------------------------------
// noodleBlade image which does all the work.  Images do not normally exist in
// the world, they can only be mounted on ShapeBase objects.

datablock ShapeBaseImageData(noodleBladeImage)
{
   // Basic Item properties
   shapeFile = "art/shapes/dotsnetcrits/weapons/noodleBlade/noodleBlade.cached.dts";
   //shapeFileFP = "art/shapes/dotsnetcrits/weapons/noodleBlade/noodleBlade.cached.dts";
   emap = false;
   ...
   //imageAnimPrefix = "noodleBlade";
   //imageAnimPrefixFP = "noodleBlade";
   ...
   //stateSound[4]                    = noodleBladeReloadSound;
   ...
   stateSound[6]                    = noodleBladeFireEmptySound;
};


//-----------------------------------------------------------------------------

function noodleBladeImage::onMount( %this, %obj, %slot )
{
...
function noodleBladeImage::onUnmount( %this, %obj, %slot )
{
   %obj.client.RefreshWeaponHud( 0, "", "" );
}

function noodleBladeImage::onFire(%this, %obj, %slot)
{
   %pos = %obj.getPosition();
   ...
   while ( (%targetObject = containerSearchNext()) != 0 )
   {
     if(%targetObject != %obj)
     {
      %targetObject.damage(%obj, %pos, %this.item.directDamage, "noodleBlade");
