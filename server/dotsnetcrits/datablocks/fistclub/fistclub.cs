//-----------------------------------------------------------------------------
// fistClub weapon. This file contains all the items related to this weapon
...
datablock ItemData(fistClub)
{
   ...
   emap = true;
    ...
    pickUpName = "a fistClub";
    description = "fistClub";
    maxInventory = 1;
...
//--------------------------------------------------------------------------
// fistClub image which does all the work.  Images do not normally exist in
...
datablock ShapeBaseImageData(fistClubImage)
{
   ...
   //imageAnimPrefix = "fistClub";
   //imageAnimPrefixFP = "fistClub";
   ...
   //stateSound[4]                    = fistClubReloadSound;
   ...
   stateSound[6]                    = fistClubFireEmptySound;
};


//-----------------------------------------------------------------------------

function fistClubImage::onMount( %this, %obj, %slot )
{
...
function fistClubImage::onUnmount( %this, %obj, %slot )
{
   %obj.client.RefreshWeaponHud( 0, "", "" );
}

function fistClubImage::onFire(%this, %obj, %slot)
{
   %pos = %obj.getPosition();
