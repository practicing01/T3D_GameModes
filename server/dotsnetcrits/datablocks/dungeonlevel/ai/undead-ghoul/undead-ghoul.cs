...
function UndeadGhoulDungeonLevel::onAdd(%this, %obj)
{
  %obj.setCloaked(true);

  %obj.sprite_ = new TSStatic()
  {
    shapeName = "art/shapes/dotsnetcrits/levels/dungeonunits/undead-ghoul/undeadghoul.cached.dts";
    collisionType = "none";
  };
...
function UndeadGhoulDungeonLevel::onRemove(%this, %obj)
{
  %obj.sprite_.delete();
}
